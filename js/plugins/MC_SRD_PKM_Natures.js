...
(function(_, $) {
	...
	var params = PluginManager.parameters('MC_SRD_PKM_Natures');
	...
	Game_Actor.prototype.param = function(paramId) {
		...
		return Math.floor(value.clamp(minValue, maxValue));
	};
...
})(MC.PKM.Natures, MC.PKM.CopyActors);

} else alert('In order to use the MC_SRD_PKM_Natures plugin, you need the MC_SRD_PKM_CopyActors plugin installed and placed above.');