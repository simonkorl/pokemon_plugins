...
Imported.MC_FFP_PKM_PokemonExpControl = true;

var MC = MC || {};
MC.PokemonExpControl = MC.PokemonExpControl || {};

MC.PokemonExpControl.initMembers = Game_Actor.prototype.initMembers;
Game_Actor.prototype.initMembers = function() {
    MC.PokemonExpControl.initMembers.call(this);
	this._exp = 0;
	this._table = 0;
	this.getActorTable();
};
