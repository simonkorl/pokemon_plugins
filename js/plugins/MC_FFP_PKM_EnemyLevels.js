...
Imported.MC_FFP_PKM_EnemyLevels = true;

var MC = MC || {};
MC.PKM = MC.PKM || {};
MC.PKM.EnemyLevel = MC.PKM.EnemyLevel || {};
MC.PKM.EnemyLevel.parameters = PluginManager.parameters('MC_FFP_PKM_EnemyLevels');

MC.PKM.EnemyLevel.isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
    if (!MC.PKM.EnemyLevel.isDatabaseLoaded.call(this)) return false;
